...
-- The shader itself, for compositing through fskit.screen.finish().
function crt.shader()
    return shader
end

-- Legacy direct compositor (unscaled). Kept for compatibility; main.lua now
-- composites via fskit.screen.finish(crt.shader()) so the frame is letterboxed.
